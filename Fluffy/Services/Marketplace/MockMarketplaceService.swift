...
struct MockMarketplaceService: MarketplaceServicing {
    ...
    func updateUserProfile(_ draft: UserProfileDraft) async throws -> UserProfile {
        ...
        return UserProfile(
            ...
            avatarURL: MockMarketplaceData.profile.avatarURL,
...
enum MockMarketplaceData {
    ...
    static let shelters: [Shelter] = [
        Shelter(
            ...
            animals: 127,
            description: "Один из старейших московских приютов. Более 2000 животных нашли дом за все время работы.",
        ...
        Shelter(
            ...
            animals: 204,
            description: "Крупнейший приют Ленинградской области. Срочно ищем передержки и волонтеров.",
